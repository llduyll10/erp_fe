/**
 * Stock In History Hook
 * Manages stock in movements list with pagination, search, and filtering
 */
...
const useStockInHistory = () => {
	const { t } = useTranslation("common");
	const [searchParams, setSearchParams] = useState<
		Omit<GetStockMovementsRequest, "page" | "limit" | "offset">
	>({
		type: StockMovementType.IN, // Only show stock in movements
	});
	...
	const clearFilters = () => {
		setSearchParams({ type: StockMovementType.IN });
		pagination.setPage(1);
	};
...
export default useStockInHistory;